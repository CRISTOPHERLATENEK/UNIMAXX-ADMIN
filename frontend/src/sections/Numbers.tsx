  ...
  return (
    <div data-reveal="up" style={{ padding: '48px 0' }}>
      <div style={{ maxWidth: '80rem', margin: '0 auto', padding: '0 clamp(1rem,3vw,2rem)' }}>
        <div ref={ref} style={{ position: 'relative', overflow: 'hidden', borderRadius: 28, padding: 'clamp(2rem,6vw,72px) clamp(1.25rem,4vw,48px)', background: '#0d0d0f', border: '1px solid rgba(255,255,255,.07)', boxShadow: '0 32px 80px rgba(0,0,0,.35)' }}>
...
function StatCardDark({ stat, pc, delay, inView }: any) {
  ...
  return (
    <div onMouseEnter={() => setHov(true)} onMouseLeave={() => setHov(false)}
      ...
      <div style={{ fontSize: 'clamp(2.8rem,5vw,4.2rem)', fontWeight: 'var(--typo-h-weight,900)', marginBottom: 8, background: `linear-gradient(135deg,#fff,${pc})`, WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', fontFamily: "var(--font-heading,'Outfit'),sans-serif", letterSpacing: '-0.04em', lineHeight: 1 }}>{stat.value}</div>
      <div style={{ fontSize: 11, fontWeight: 700, color: 'rgba(255,255,255,.4)', textTransform: 'uppercase', letterSpacing: '0.16em', fontFamily: "var(--font-body,'DM Sans'),sans-serif" }}>{stat.label}</div>
